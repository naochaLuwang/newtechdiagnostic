...
const AboutPage = () => {
  return (
    <div className="w-full h-auto px-4 py-8 lg:py-16 lg:px-0 bg-neutral-100">
      <div className="flex flex-col w-full lg:mx-auto lg:max-w-7xl ">
        <h1 className="text-3xl font-semibold lg:text-6xl text-neutral-700">
          ABOUT US
        </h1>
        <div className="grid w-full grid-cols-1 pb-20 mt-5 lg:gap-10 lg:grid-cols-2">
          <div className="flex flex-col space-y-5">
            <p className="text-base font-light leading-relaxed tracking-wider text-justify lg:text-lg text-neutral-700">
              <span className="font-medium tracking-wider text-teal-600">
                NEW
              </span>
              <span className="font-medium tracking-wider text-orange-600">
                TECH
              </span>{" "}
              is among the best medical diagnostic centre in Imphal. We are
              situated at Ayangpalli Road near JNIMS Gate, Imphal. We maintain
              the highest standards of the Testing procedure with a dedicated
              team of highly qualified radiologists, pathologists, and
              technicians, and we are equipped with state-of-the-art, innovative
              machines to ensure precision and efficiency in our diagnostic
              processes.
            </p>
            <p className="text-lg font-light leading-relaxed tracking-wider text-justify text-neutral-700">
              ...
              Diagnostics, we have we believe in a Patient-Centric Approach and
              hence our Diagnostics Centre is ergonomically designed keeping in
            ...
            <p className="text-base leading-relaxed lg:text-lg">
              ...
              NewTech Diagnostics Centre is equipped with the most modern
              diagnosis machines and facilities.
            </p>
      ...
      <div className="flex flex-col items-center justify-center w-full mx-auto space-y-5 lg:max-w-2xl">
        ...
        <p className="text-sm font-light text-center lg:text-base">
          ...
          equipped with Modern Facilities and well Qualified Staff.
        </p>
      </div>
      ...
      <div className="grid w-full max-w-6xl grid-cols-1 mx-auto mt-20 lg:gap-6 gap-9 lg:grid-cols-3">
        {chooses.map((choose, index) => (
          ...
          >
            ...
            <p className="font-light leading-loose text-center lg:text-left">
              {choose.description}
            </p>
          </div>
        ))}
